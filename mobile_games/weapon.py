...
input_subscription = "projects/streaming-445511/subscriptions/Topic8-sub"

# Replace with your output subscription id
output_topic = "projects/streaming-445511/topics/Topic9"
...
pubsub_data = (
               ...
               # | 'Apply custom timestamp' >> beam.Map(custom_timestamp)
                ...
                | 'Window for player' >> beam.WindowInto(window.Sessions(5))
